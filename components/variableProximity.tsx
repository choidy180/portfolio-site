...
// ✅ RefObject / MutableRefObject 모두 호환되는 얇은 타입
...
// ✅ 인자 타입도 RefLike<HTMLDivElement>로 통일
function useMousePositionRef(containerRef: RefLike<HTMLDivElement>) {
...
interface VariableProximityProps extends HTMLAttributes<HTMLSpanElement> {
  ...
  containerRef: RefLike<HTMLDivElement>; // ✅ 여기만 맞추면 끝
  radius?: number;
